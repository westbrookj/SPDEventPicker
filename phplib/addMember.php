<?php
    ...
    if($firstName == -1 or $lastName == -1 or $setup == -1 or $cleanup == -1 or $monitor == -1 or $drive == -1) {
        $status = 'error';
        $error = 'Empty form elements!';
        errorAndDie();
    }

    $sql = "INSERT INTO members (firstName, lastName, setup, cleanup, monitor, drive) VALUES ('$firstName', '$lastName', '$setup', '$cleanup', '$monitor', '$drive')";
